...
There is obvious merit in having a high quality reference genome available for a particular organism but a high quality assembly isn't always the primary goal of a de novo sequencing project. This is partly because one of the primary influencing factors in planning a project is money. There is a huge amount of research available regarding the differences between assembly tools and underlying algorithms [@cherukuri_2016; @giordano_2017; @khan_2018], the quality of genomes assembled using data from different sequencing platforms [@wenger_2019; @giordano_2017] and the error profiles of sequencing technologies []. However, there isn't a lot of information available to help a researcher get the most from their available resources. These resources include the amount of money they have, their experience with de novo assembly pipelines and their computing resources, all of which must be considered in conjunction with time frame, the size of the genome of interest, and quality requirements in order to properly optimise a project. An in-depth analysis of all possible combinations of data input and piplines would be impossible and so a literature review is used to finetune the scope of the project. This includes an understanding of current sequencing technologies, methods of measuring assembly quality, a knowledge of different pipelines and methods for assembly as well as ways to ensure pipeline reproducibility, a key component of responsible, ethical research. 
